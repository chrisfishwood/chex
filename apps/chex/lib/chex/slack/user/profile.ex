defmodule Chex.Slack.User.Profile do
  ...
  schema "slack_user_profiles" do
    ...
    belongs_to :slack_user, Chex.Slack.User
  ...
  def changeset(%Profile{} = profile, attrs) do
    profile
    |> cast(attrs, [:avatar_hash, :display_name, :display_name_normalized, :email, :first_name, :image_1024, :image_192, :image_24, :image_32, :image_48, :image_512, :image_72, :image_original, :last_name, :phone, :real_name, :real_name_normalized, :skype, :status_emoji, :status_text, :team, :title])
  end
end
